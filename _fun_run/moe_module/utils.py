...
def generate_data(vxn, vtn, nu, writer):
    ...
    """
    # === 1️⃣ 读取真实解 ===
    mat_path = "/home/zhy/Zhou/mixture_of_experts/_fun_run/data/burgers_shock.mat"
...
def save_model(model,name='mlp'):
    ...
    # 拼出文件名
    save_path ="/home/zhy/Zhou/mixture_of_experts/_fun_run/saved_model/model_"+name+f"{t}.pth"

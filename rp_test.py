...
def parse_args():
    ...
    parser.add_argument("--smooth_lb",type=int,default=8000,help="number lower bound of steps for smooth mode")
...
def eval_model(x, y, model, loss_fn,moe_training=True,args=None):
    ...
    if moe_training:
        ...
        if model.model.smooth:
            ...
            gates,_,_=model.model.gating_network(x,False)
            gates= model.model.soft_topk(gates, model.model.k)
